...
os.environ['STANFORD_PARSER'] = 'C:/Users/Alisha-PC/Desktop/college stuff/Mega Project/jars'
os.environ['STANFORD_MODELS'] = 'C:/Users/Alisha-PC/Desktop/college stuff/Mega Project/jars'
...
print("ISL Syntax : {}".format(isl_text_string))

# VIDEO STITCHING CODE GOES HERE


# parser = StanfordParser(model_path="C:/Users/Alisha-PC/Desktop/college stuff/Mega Project/jars/englishPCFG.ser.gz")
# sentences = parser.raw_parse_sents(("Hello, My name is Alisha.", "What is your name?"))
# print(sentences)
